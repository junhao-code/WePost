...
func main() {
	...
	//r.Handle("/post", jwtMiddleware.Handler(http.HandlerFunc(enableCors))).Methods("OPTIONS")
	//r.Handle("/search", jwtMiddleware.Handler(http.HandlerFunc(handlerSearch))).Methods("GET")
	//r.Handle("/search", jwtMiddleware.Handler(http.HandlerFunc(enableCors))).Methods("OPTIONS")
	//r.Handle("/login", http.HandlerFunc(loginHandler)).Methods("POST")
	//r.Handle("/login", http.HandlerFunc(enableCors)).Methods("OPTIONS")
	//r.Handle("/signup", http.HandlerFunc(signupHandler)).Methods("POST")
	//r.Handle("/signup", http.HandlerFunc(enableCors)).Methods("OPTIONS")
